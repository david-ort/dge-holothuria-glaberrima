...
group <- c(rep("Day_12_Post-injury", 2), rep("Uninjured_Radial_Organ",2))
...
pdf("pepino-edgeR-MA-12vsUNIN-plot.pdf")
plot(
  etp$table$logCPM,
  etp$table$logFC,
